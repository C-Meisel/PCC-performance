...
def objective(trial):
    ...
    n_estimators = trial.suggest_int('n_estimators', 50, 100)  # trial.suggest_int('n_estimators', 10, 100) 
    max_features = trial.suggest_float('max_features', 0.1, 1.0) # trial.suggest_float('max_features', 0.1, 1.0)
    min_samples_split = trial.suggest_int('min_samples_split', 2, 10) # trial.suggest_int('min_samples_split', 2, 10)
    min_samples_leaf = 1 # trial.suggest_int('min_samples_leaf', 1, 3)  # trial.suggest_int('min_samples_leaf', 1, 3)  1
    ccp_alpha = 0 #trial.suggest_float('ccp_alpha', 0.001, 0.01)
    rs = rs_hyp #trial.suggest_int('rs', 1, 100) # trial.suggest_int('rs', 1, 100) rs_hyp
